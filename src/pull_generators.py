#!/usr/bin/env python3
"""
src/pull_generators.py — Exporta Generators de CX -> YAMLs locales.
...
Uso:
  python src/pull_generators.py --dry-run
  python src/pull_generators.py
  python src/pull_generators.py --only MyGenerator
"""
import argparse
import os
import re
