#!/usr/bin/env python3
"""
src/pull_environments.py — Exporta Environments de CX -> YAMLs locales.

Espejo READ-ONLY de push_environments.py (Sprint 5, PR12). Solo GET;
nunca POST/PATCH/DELETE.

Uso:
  python src/pull_environments.py --dry-run
  python src/pull_environments.py
  python src/pull_environments.py --only Production
"""
import argparse
import os
import re
