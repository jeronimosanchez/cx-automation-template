#!/usr/bin/env python3
"""
src/pull_playbooks.py — Exporta Playbooks de CX -> YAMLs locales.
...
Uso:
  python src/pull_playbooks.py --dry-run
  python src/pull_playbooks.py
  python src/pull_playbooks.py --only Handoff
"""
import argparse
import os
import re
