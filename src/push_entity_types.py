#!/usr/bin/env python3
"""
src/push_entity_types.py — Crear/upsert Entity Types de Dialogflow CX.
...
Uso:
  python src/push_entity_types.py --file=definitions/entity_types/example_entity_type.yaml --dry-run
  python src/push_entity_types.py --all --dry-run
  python src/push_entity_types.py --all --only Test_Color --dry-run
"""
import argparse
import os
import subprocess
