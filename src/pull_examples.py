#!/usr/bin/env python3
"""
src/pull_examples.py — Exporta Examples de CX -> YAMLs locales.
...
Uso:
  python src/pull_examples.py --dry-run
  python src/pull_examples.py
  python src/pull_examples.py --only "Ex_Reg_01"
"""
import argparse
import os
import re
