#!/usr/bin/env python3
"""
src/pull_agent_config.py — Exporta config del agente CX -> YAML local.
...
Uso:
  python src/pull_agent_config.py --dry-run   # imprime que escribiria
  python src/pull_agent_config.py             # escribe (solo bloque agent_definition:)
"""
import argparse
import os
import sys
