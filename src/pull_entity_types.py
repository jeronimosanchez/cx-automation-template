#!/usr/bin/env python3
"""
src/pull_entity_types.py — Exporta Entity Types de CX -> YAMLs locales.
...
Uso:
  python src/pull_entity_types.py --dry-run   # lista que escribiria, sin tocar FS
  python src/pull_entity_types.py             # escribe los YAMLs
  python src/pull_entity_types.py --only Color
"""
import argparse
import os
import re
