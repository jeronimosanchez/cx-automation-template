#!/usr/bin/env python3
"""
src/push_pages.py — Crear/upsert Pages de Dialogflow CX (anidadas bajo Flow).
...
Uso:
  python src/push_pages.py --file=definitions/pages/example_page.yaml --dry-run
  python src/push_pages.py --all --dry-run
  python src/push_pages.py --all --flow Test_Flow --dry-run
  python src/push_pages.py --all --only Test_Page --dry-run
"""
import argparse
import os
import subprocess
