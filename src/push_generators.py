#!/usr/bin/env python3
"""
src/push_generators.py — Crear/upsert Generators de Dialogflow CX.
...
Uso:
  python src/push_generators.py --file=definitions/generators/example_generator.yaml --dry-run
  python src/push_generators.py --all --dry-run
  python src/push_generators.py --all --only Test_Greeting_Generator --dry-run
"""
import argparse
import os
import subprocess
