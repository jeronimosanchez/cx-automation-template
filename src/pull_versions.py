#!/usr/bin/env python3
"""
src/pull_versions.py — Exporta Versions de CX como manifest-only.
...
Uso:
  python src/pull_versions.py --dry-run
  python src/pull_versions.py
  python src/pull_versions.py --only ci-8
"""
import argparse
import os
import re
