#!/usr/bin/env python3
"""qap/rebuild_history.py — Genera qa/history.json para la vista Histórico del dashboard.
...
Modos:
  Solo backfill (lista todos los dirs de gh-pages, no añade nuevos):
      python qap/rebuild_history.py --out /tmp/history.json

  En CI (añade un run local no publicado todavía):
      python qap/rebuild_history.py \\
