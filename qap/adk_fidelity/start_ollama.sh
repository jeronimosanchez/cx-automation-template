...
export OLLAMA_CONTEXT_LENGTH=32768    # ADK-22: el prompt de Petal (~32k) cabe sin truncar. Default 4096 truncaba → baseline envenenado
...
echo "Ollama arrancado: flash attention ON + contexto 32k + keep_alive (log: /tmp/ollama_adk.log)"
