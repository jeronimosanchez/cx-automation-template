"""Tests unitarios para src/pull_agent_config.py.
...
from src.pull_agent_config import (
    MARKER,
    PULL_STRIP_FIELDS,
    cx_to_local,
    surgical_write,
)
from src.push_agent_config import AGENT_IGNORE_FIELDS, resolve_local_body
