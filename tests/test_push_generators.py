"""Tests unitarios para src/push_generators.py.
...
from src.push_generators import (
...
def test_list_generators_paginates():
    ...
    with patch("src.push_generators.requests.get") as mg:
...
def test_upsert_generator_created_when_missing():
    ...
    with patch("src.push_generators.requests.post") as mp:
...
def test_upsert_generator_unchanged():
    ...
    with patch("src.push_generators.requests.get") as mg, \
         patch("src.push_generators.requests.patch") as mpa, \
         patch("src.push_generators.requests.post") as mp:
