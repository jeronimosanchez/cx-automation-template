...
- [`automatizacion/epic_separar_qa_html_generator.md`](automatizacion/epic_separar_qa_html_generator.md) — épica: separar `test_QA_Playbooks_v23.py` en 3 módulos (tc_definitions, qa_runner, qa_html_generator). Hoy el fichero mezcla TCs + runner + HTML (~2600 líneas). Trigger: >3000 líneas o colaboradores tocando HTML sin tocar TCs. ~1 día, bajo riesgo.
