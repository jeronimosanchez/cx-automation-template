#!/usr/bin/env python3
"""
act/pull_intents.py — Exporta Intents de CX -> YAMLs locales.
...
Uso:
  python act/pull_intents.py --dry-run   # lista que escribiria, sin tocar FS
  python act/pull_intents.py             # escribe los YAMLs
  python act/pull_intents.py --only "Default Welcome Intent"
"""
import argparse
import os
import re
