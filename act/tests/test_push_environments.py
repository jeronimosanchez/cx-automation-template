"""Tests unitarios para act/push_environments.py.
...
from act.push_environments import (
...
def test_list_environments_paginates():
    ...
    with patch("act.push_environments.requests.get") as mg:
...
def test_upsert_environment_created_when_missing():
    ...
    with patch("act.push_environments.requests.post") as mp:
...
def test_upsert_environment_unchanged_when_match():
    ...
    with patch("act.push_environments.requests.get") as mg, \
         patch("act.push_environments.requests.patch") as mpa, \
         patch("act.push_environments.requests.post") as mp:
