"""Tests unitarios para act/push_tools.py.
...
def test_list_tools_paginates():
    ...
    with patch("act.push_tools.requests.get") as mg:
...
def test_upsert_tool_created_when_missing():
    ...
    with patch("act.push_tools.requests.post") as mp:
...
def test_upsert_tool_unchanged_when_match():
    ...
    with patch("act.push_tools.requests.get") as mg, \
         patch("act.push_tools.requests.patch") as mpa, \
         patch("act.push_tools.requests.post") as mp:
