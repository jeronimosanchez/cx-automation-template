"""Tests unitarios para act/push_flows.py.
...
def test_list_flows_paginates():
    ...
    with patch("act.push_flows.requests.get") as mg:
...
def test_upsert_flow_created_when_missing():
    ...
    with patch("act.push_flows.requests.post") as mp:
...
def test_upsert_flow_unchanged_when_match():
    ...
    with patch("act.push_flows.requests.get") as mg, \
         patch("act.push_flows.requests.patch") as mpa, \
         patch("act.push_flows.requests.post") as mp:
