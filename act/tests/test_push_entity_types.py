"""Tests unitarios para act/push_entity_types.py.
...
from act.push_entity_types import (
...
def test_list_entity_types_paginates():
    ...
    with patch("act.push_entity_types.requests.get") as mg:
...
def test_upsert_entity_type_created_when_missing():
    ...
    with patch("act.push_entity_types.requests.post") as mp:
...
def test_upsert_entity_type_unchanged():
    ...
    with patch("act.push_entity_types.requests.get") as mg, \
         patch("act.push_entity_types.requests.patch") as mpa, \
         patch("act.push_entity_types.requests.post") as mp:
