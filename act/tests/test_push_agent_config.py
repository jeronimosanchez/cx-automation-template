"""Tests unitarios para act/push_agent_config.py.
...
from act.push_agent_config import (
    AGENT_IGNORE_FIELDS,
    agent_path,
    get_agent,
    patch_agent,
...
def test_get_agent_returns_body():
    ...
    with patch("act.push_agent_config.requests.get") as mg:
...
def test_patch_agent_sends_update_mask_param():
    with patch("act.push_agent_config.requests.patch") as mpa:
