#!/usr/bin/env python3
"""
act/push_examples.py — Crear/upsert Examples en un Playbook de Dialogflow CX.
...
Uso:
  ...
  python act/push_examples.py --file=definitions/examples/registro_task/ex_reg_01.yaml --dry-run
  python act/push_examples.py --all --dry-run
  python act/push_examples.py --all --only "Ex_Reg_01"  # filtra por displayName
"""
import argparse
import os
import subprocess
...
# Permitir import directo desde act/ tanto al ejecutar el script
# (`python act/push_examples.py`) como al importarlo desde un test.
