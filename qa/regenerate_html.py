#!/usr/bin/env python3
"""
qa/regenerate_html.py — Regenera el HTML del QA SIN llamar a CX.
...
Uso:
    ...
    python qa/regenerate_html.py

    # Modo 2: usar logs de gh-pages (run específico)
    python qa/regenerate_html.py --ts 20260518_192907

    # Modo 3: usar carpeta arbitraria
    python qa/regenerate_html.py --logs-dir /path/to/logs
